...
export default function UpdatesPage() {
  ...
  const handleSubmitUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://ofstaging.azurewebsites.net/api/profile/create-update", {
        method: "POST",
        headers:{
          user_id: userID,
        },
      ...
      const updatedResponse = await fetch(
        "https://ofstaging.azurewebsites.net/api/profile/get-updates-in-dashboard",
        {
          headers: {
            user_id: userID,
          },
  ...
  useEffect(() => {
    const fetchUpdates = async () => {
      try {
        ...
        const response = await fetch("https://ofstaging.azurewebsites.net/api/profile/get-updates-in-dashboard", {
          headers: {
            user_id: userID,
          },
        })
